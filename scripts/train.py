...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, help="Training mode (structure or color)", default=None)
    ...
    parser.add_argument("--ckpt-dir", type=str, help="Checkpoint directory", default=None)
