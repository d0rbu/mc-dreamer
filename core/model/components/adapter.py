...
from modular_diffustion.module.components.adapter import ConvAdapter
from modular_diffustion.module.components.adapter import ConvLinearAdapter
from modular_diffustion.module.components.adapter import LinearAdapter
from typing import Tuple, Optional, Union

class LinearAdapter3D(LinearAdapter):
    '''
